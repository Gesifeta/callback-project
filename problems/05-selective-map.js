...
let selectiveMap = function (array, cb1, cb2) {
    ...
    for (let j = 0; j < array.length; j++) {
        //checking of callback is returning true, 
        if (cb1(array[j])) {
            //if it returns true, call callback two and push the result to new array.
            newArray.push(cb2(array[j]))
        }
        else {
            //else push original i's element to new array.
